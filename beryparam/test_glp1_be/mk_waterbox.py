...
# Read in the pdb
pdb_input = "sys_vacuum.pdb"
# Read in the psf
psf_input = "sys_vacuum.psf"
...
# Add potassium ion
    ...
    print(num_particles)
    modeller = add_ion(modeller, ref_index=18, atomic_num=19)
    system = add_inverted_flat_bottom_restraint(system, atom1=18, atom2=19 )
    system.getNumConstraints()
elif sys_charge >0:
# Add chloride ions
    num_particles = system.getNumParticles()
    print(num_particles)
    modeller = add_ion(modeller, ref_index=18, atomic_num=17)
    system = add_inverted_flat_bottom_restraint(system, atom1=18, atom2=19 )
    system.getNumConstraints()
...
PDBFile.writeFile(modeller.topology, modeller.positions, open('mol_water.pdb', 'w'))
