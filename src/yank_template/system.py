...
class System:
    ...
    def write_psf(self, psf_outfile):
        """
        Write the psf file to psf_outfile.
        """
        if self.psf: # FIX check if psf or crd exists
            logger.info(f"Wrote psf to {psf_outfile}.")
        else:
            logger.info("PSF was not written. Load crd/psf first.")
